...
export function King({ color, size = 45 }: PieceProps) {
  const fill = color === "white" ? "#f0e6d3" : "#1a1a2e";
  const stroke = color === "white" ? "#8b7355" : "#4f46e5";
  return (
...
export function Queen({ color, size = 45 }: PieceProps) {
  const fill = color === "white" ? "#f0e6d3" : "#1a1a2e";
  const stroke = color === "white" ? "#8b7355" : "#4f46e5";
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function Rook({ color, size = 45 }: PieceProps) {
  const fill = color === "white" ? "#f0e6d3" : "#1a1a2e";
  const stroke = color === "white" ? "#8b7355" : "#4f46e5";
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function Bishop({ color, size = 45 }: PieceProps) {
  const fill = color === "white" ? "#f0e6d3" : "#1a1a2e";
  const stroke = color === "white" ? "#8b7355" : "#4f46e5";
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function Knight({ color, size = 45 }: PieceProps) {
  const fill = color === "white" ? "#f0e6d3" : "#1a1a2e";
  const stroke = color === "white" ? "#8b7355" : "#4f46e5";
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function Pawn({ color, size = 45 }: PieceProps) {
  const fill = color === "white" ? "#f0e6d3" : "#1a1a2e";
  const stroke = color === "white" ? "#8b7355" : "#4f46e5";
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
const PIECE_COMPONENTS: Record<string, React.ComponentType<PieceProps>> = {
  k: King, q: Queen, r: Rook, b: Bishop, n: Knight, p: Pawn,
};

export function ChessPiece({ type, color, size }: { type: string; color: "white" | "black"; size?: number }) {
  const Component = PIECE_COMPONENTS[type.toLowerCase()];
